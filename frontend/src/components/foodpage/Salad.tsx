...
export const SaladFood = () => {
  ...
  const foods: FoodItem[] = [
    {
      _id: 1,
      img: "https://res.cloudinary.com/demo/image/upload/getting-started/shoes.jpg",
      text: "Өглөөний хоол",
      amount: 5000,
  ...
  return (
    <div className="flex flex-col gap-6 py-[10px] px-4 container mx-auto">
